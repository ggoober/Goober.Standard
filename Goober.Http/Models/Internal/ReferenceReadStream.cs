...
{
    //implementation from https://github.com/dotnet/aspnetcore/blob/main/src/Http/Http/src/Internal/ReferenceReadStream.cs
    internal sealed class ReferenceReadStream : Stream
    {
        ...
        {
            if (_inner.CanSeek && _inner.Position != _innerOffset + _position)
            {
